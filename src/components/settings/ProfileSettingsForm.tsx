    ...
    >
      <div>
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-base font-semibold text-foreground">Attendee Profile</h4>
        </div>
        <p className="text-xs text-muted-foreground mt-0.5 leading-relaxed">
          Your profile information is used for one-click pass registration and personalized MICE event suggestions.
        </p>
      </div>
      ...
      <div className="space-y-3 pt-2 border-t border-border/60">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          Select the exhibition categories you frequently attend for tailored discovery feeds.
        </p>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-3 border-t border-border/60">
        ...
        <Button type="submit" size="sm" className="w-full sm:w-auto px-5">
