...
export const ARCHETYPE_METAS: Record<MiceArchetype, ArchetypeMeta> = {
  INDUSTRIAL_B2B: {
    ...
    description: "Manufacturing expos, heavy equipment showcases, CNC machinery tooling, and industrial B2B procurement tenders.",
  ...
  TECH_DEV_SUMMIT: {
    id: "TECH_DEV_SUMMIT",
    label: "Tech & Developer Summit",
    description: "Developer conventions, AI engineering symposiums, cloud architecture keynotes, and hackathons.",
  ...
  MEDICAL_SYMPOSIUM: {
    ...
    description: "Clinical congresses, biomedical research symposiums, and CME-accredited specialty breakout sessions.",
  ...
  FINANCE_INVESTOR: {
    ...
    description: "FinTech summits, institutional investor assemblies, venture capital pitch stages, and private deal-rooms.",
  ...
  POP_CULTURE_GAMING: {
    ...
    description: "Comic conventions, esports championship arenas, illustrator creator alleys, and cosplay showcases.",
  ...
  MUSIC_FESTIVAL: {
    id: "MUSIC_FESTIVAL",
    label: "Music Festival & Concert",
    description: "Multi-stage live music festivals, arena concert tours, acoustic floor plans, and RFID gate control.",
  ...
  MEGA_EXPO_PAVILION: {
    ...
    description: "Multi-pavilion consumer trade expos, national cultural fairs, nocturnal fireworks, and culinary bazaars.",
  ...
  GOVERNMENT_DIPLOMATIC: {
    ...
    description: "State bilateral conference suites, inter-governmental policy briefings, and diplomatic delegation forums.",
  ...
  INCENTIVE_RETREAT: {
    ...
    label: "Incentive & Corporate Retreat",
    description: "Corporate incentive travel programs, executive leadership retreats, curated itineraries, and waterfront galas.",
  ...
  AUTOMOTIVE_MOBILITY: {
    ...
    description: "International motor shows, EV battery ecosystems, track test drives, and concept vehicle debuts.",
  ...
  ENERGY_INFRASTRUCTURE: {
    ...
    description: "Renewable energy grids, heavy extraction machinery, mining tech, and strategic infrastructure projects.",
  ...
  AGRITECH_FOOD: {
    id: "AGRITECH_FOOD",
    label: "Agritech & Food",
    description: "Smart precision agriculture demos, cold-chain logistics networks, and international food commodity trade.",
  ...
  HOSPITALITY_TOURISM: {
    ...
    description: "International travel buyer appointments, hotelier supply procurement, and tourism destination showcases.",
  ...
  EDUCATION_EDTECH: {
    ...
    description: "Global university admission fairs, academic scholarship counseling, and digital learning innovations.",
  ...
  FASHION_RETAIL: {
    ...
    description: "Designer runway showcases, cosmetic contract manufacturing (OEM), and wholesale retail trade orders.",
